...
import com.user.mgmt.util.JwtUtil;
...
public class JwtService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
    	...
    	User user = userRepository.findById(username).get();
    	org.springframework.security.core.userdetails.User userDetailObj=null;
        if (user != null) {
        	userDetailObj = new org.springframework.security.core.userdetails.User(
                    user.getUserName(),
